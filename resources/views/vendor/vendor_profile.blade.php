                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    {{---disabled -> to make the input value unable to change---}}
                                    {{--we do not use a name here because we use disabled ---}}
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="file" name="photo" class="form-control" id="image" accept="image/x-png,image/gif,image/jpeg,image/jpg,image/webp"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <img src="{{ (!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo):url('upload/no_image.jpg')}}" alt="Vendor" id="showImage" style="width: 160px; height:130px;">
                                </div>
                            </div>
