                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <input type="file" name="slider_image" class="form-control" id="image" required="" accept="image/x-png,image/gif,image/jpeg,image/jpg,image/webp"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <img src="{{ url('upload/no_image.jpg')}}" alt="slider" id="showImage" style="width: 160px; height:130px;">
                                </div>
                            </div>
