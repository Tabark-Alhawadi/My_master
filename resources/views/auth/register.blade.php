...
<head>
    <meta charset="utf-8" />
    <title>Register - you and me </title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <input id="password_confirmation" required="" type="password" name="password_confirmation" placeholder="Confirm password" />
                                            </div>
                                            ...
                                            <div class="form-group mb-30">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up font-weight-bold" name="login" style="background: linear-gradient(to left, #8067A9, #24012f);"> Sgin Up</button>
                                            </div>
